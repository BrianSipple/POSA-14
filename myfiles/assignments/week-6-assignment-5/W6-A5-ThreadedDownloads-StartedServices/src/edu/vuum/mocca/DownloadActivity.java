...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        mUri = ((EditText) findViewById(R.id.url)).getText().toString();
        ...
        case R.id.intent_service_button:
            ...
            mIntent = DownloadIntentService.makeIntent(this, handler, mUri);       // make the intent

            startService(mIntent);      // start the intent... which will be directed to DownloadIntentService
        ...
        case R.id.thread_pool_button:
            ...
            mIntent = ThreadPoolDownloadService.makeIntent(this, handler, mUri);
    ...
    /**
     * Helper method that takes a passed in view,
     * finds the EditText element containing the URI entry,
     * extracts its current text and returns it as a String
     * @return uri
     */
