...
public class DownloadIntentService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        //DownloadUtils.makeMessengerIntent creates an intent that stores a messenger as an extra and the uri string as data
        return DownloadUtils.makeMessengerIntent(
                context,
                DownloadIntentService.class,    // the intent will know to start this service
                handler,
                uri);
    }
